...
var chain = 3               // 3 = Ropsten test net, 1 = mainnet

                 //   Contract address & ABI used for testing:
...
var BlockRewards = {
    ...
    /**
     * Format a transaction that can be published to the Ethereum blockchain to 
    ...
    /**
     * Push a formatted and signed transaction to the blockchain.
    ...
    // Functions not yet functioning:

    /**
     * This function will deploy a compilied contract to the blockchain
     * @param {string} bytecode for the contract you wish to deploy
     */
